...
import { ManagerSearchBar, mapStateToProps } from '../components/pages/manager/ManagerSearchBar';
...
const setUp = (initialState =  {}) => {
  ...
  const wrapper = shallow(
      <ManagerSearchBar {...props} store={store} />
  );
    return wrapper;
} 

describe('ManagerSearchBar Test Suite', () => {
