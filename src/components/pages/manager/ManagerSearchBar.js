...
export class ManagerSearchBar extends Component {
  state = {
    username: '',
    origin: '',
    destination: '',
      ...
      { openSearch && (
        <Container className="search-bar">
          <Row className="center-items">
            <Col xs={12} sm={6} md={4} lg={4}>
              <Form.Group>
                <Form.Control type="text" name="username" onChange={this.handleChange} placeholder="name..." minLength="10" maxLength="100" />
              </Form.Group>
            </Col>
            <Col xs={12} sm={6} md={4} lg={4}>
            <Form.Group>
            ...
            <Col xs={12} sm={6} md={4} lg={4}>
              <Button className="full-width-buttons" style={{ width: '95%' }} onClick={() => this.searchRequest()} data-test="search-request">
                SEARCH
              </Button>
            </Col>
          </Row>
...
export default connect(mapStateToProps, { getLocations, managerSearchRequestAction })(ManagerSearchBar);
